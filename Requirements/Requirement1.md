# Requirement 1: Add Attribute Patterns Interface to IBaseRegistryItem
...
Add a new interface `AttrPattern` that captures the essence of attribute-to-property mapping:
...
export interface IBaseRegistryItem<T = any> {
  ...
  // NEW: Attribute patterns for initial value reading
